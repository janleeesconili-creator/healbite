...
function openBranch(id){if(!unlocked.has(id)){let pin=prompt('Enter clinic PIN');if(pin!=='2026'){if(pin!==null)alert('Incorrect PIN');render();return}unlocked.add(id)}activeClinic=id;dashBranch=id;branch=id;view='scoreboard';period='all';render()}
